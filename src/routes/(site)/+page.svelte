...
<section class="relative overflow-hidden">
  ...
  <div
    class="absolute inset-0 bg-gradient-to-b from-maroon-600/20 via-maroon-700/20 to-maroon-900"
  ></div>
  ...
  >
    ...
    <div class="flex-1 max-w-2xl">
      ...
      <p class="text-lg text-amber-100/90 mb-8">
        Prof. Dr. R Nithya & Prof. Dr. R Vidya - acclaimed Carnatic vocalists
        with over 25 years of concerts, teaching, and research in India and
        across the globe.
      </p>
    ...
    <div class="grid gap-6 md:grid-cols-3">
      ...
      >
        ...
        <div class="p-5">
          ...
          <p class="mt-2 text-sm text-amber-100/80">
            Explore the scholarly contributions of Prof. Dr. R Nithya & Prof.
            Dr. R Vidya
          </p>
        </div>
      </a>
  ...
  >
    <div in:fade={{ delay: 200 }}>
      ...
      <p class="mt-4 text-amber-100/90">
        Disciples hailing from a rich guru parampara of Carnatic music. The
        Swetaranyam Sisters have performed across premier sabhas in Chennai and
        beyond, presented lec-dems, accompanied dance productions, and are
        extensively training numerous students worldwide.
      </p>
  ...
  <div class="relative max-w-5xl mx-auto px-6 lg:px-8">
    <header class="text-center mb-12">
      ...
      <p class="mt-3 text-amber-100/80 max-w-2xl mx-auto">
        For concerts, workshops, or classes, share your details and we'll get
        back to you shortly.
      </p>
    </header>
    ...
    >
      ...
      <div class="grid sm:grid-cols-2 gap-6">
        <div>
          <label for="organization" class="text-sm font-medium text-gold-200"
            >Organization</label
          >
          <input
            id="organization"
